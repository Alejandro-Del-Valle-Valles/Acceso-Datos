...
namespace EmpresaADONET.Exercise
{
    internal static class Exercise03App
    {
        ...
        private static List<Client> CreateClients()
        {
            ...
            clients.Add(new(1, "Alejandro", "ejemplo1@email.com", new DateTime(2006, 5, 13), true, 5, 20));
            clients.Add(new(2, "Miguel", "ejemplo2@email.com", new DateTime(2004, 4, 1), false, 5, 20));
            clients.Add(new(3, "Laura", "ejemplo3@marcosmr.edu", new DateTime(2008, 11, 21), true, 5, 20));
            clients.Add(new(4, "Sofía", "ejemplo4@marcosmr.edu", new DateTime(2012, 3, 30), true, 5, 20));
            clients.Add(new(5, "Marcos", "", new DateTime(2000, 1, 4), false, 5, 20));
            return clients;
        }
    }
}
